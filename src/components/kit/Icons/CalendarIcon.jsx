...
const CalendarIcon = ({ mainColor, secColor, className }) => {
  return (
	...
	s-1-0.44772-1-1V4.00024H5c-1.65685,0-3,1.34315-3,3v2h20v-2C22,5.34339,20.65685,4.00024,19,4.00024L19,4.00024z"
      />
      <circle cx="7" cy="13" r="1" fill={mainColor} />
      <circle cx="7" cy="17" r="1" fill={mainColor} />
      <circle cx="12" cy="13" r="1" fill={mainColor} />
      <circle cx="12" cy="17" r="1" fill={mainColor} />
      <circle cx="17" cy="13" r="1" fill={mainColor} />
      <circle cx="17" cy="17" r="1" fill={mainColor} />
      <path
        fill={secColor}
